...
if __name__ == "__main__":
    ...
    parser.add_argument("--bert_model", type=str, default="bert-base-uncased", help="The name of bert.")
    parser.add_argument("--model_path", type=str, default="checkpoint/model_best", help="The path of saved model that you want to load.")
    parser.add_argument("--test_path", type=str, default="data/reddit", help="The path of test set.")
